#!/usr/bin/env bash
set -euo pipefail
task_dir=/home/ajmalrasi/json-schema-phase4d-20260923
...
date -Is
echo PHASE4D_SCOPE=isolated-short-calibration
...
echo PHASE4D_SHORT_CALIBRATION=passed
