#!/usr/bin/env bash
set -euo pipefail
task_dir=/home/ajmalrasi/json-schema-gpu-mask-20260923
...
date -Is
echo GPU_MASK_SCOPE=isolated-incremental-build
...
restore() {
  ...
  free -m
  echo "GPU_MASK_BUILD_EXIT=$result"
  date -Is
  exit "$result"
}
trap restore EXIT
...
echo GPU_MASK_INCREMENTAL_BUILD=passed
